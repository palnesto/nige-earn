...
const actionCards = [
  {
    title: "Write Your First Post on X @Nigeearn",
  ...
  {
    title: "Simply like any recent @Nigeearn post to get rewarded.",
  ...
  {
    title: "Drop a genuine reply under @Nigeearn latest posts.",
  ...
  {
    title:
      "Retweet any official @Nigeearn tweet to support the mission and earn coins.",
  ...
  {
    title: "Quote-tweet any @Nigeearn tweet to share your take.",
    gradient: "blueTeal" as const,
    buttonText: "Get 5 coins",
